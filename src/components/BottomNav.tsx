...
export const BottomNav = () => {
	...
	return (
		<>
			{
				address &&
				<nav className='sm:hidden fixed z-100 bottom-0 w-full bg-white pb-safe dark:bg-black dark:bg-opacity-90 dark:border-t dark:border-gray-900 shadow-[0_0px_10px_0px_rgba(0,0,0,0.2)]'>
					{
