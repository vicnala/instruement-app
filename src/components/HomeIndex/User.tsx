          ...
          isLoading ? (<NFTGridLoading />) :
            owned && owned.length ?
              ...
              <>
                ...
                <p className="mb-4 text-base text-center text-gray-900 dark:text-gray-500">
                  {
                ...
                <div className="flex items-center justify-center">
                  <div className="p-4 rounded-xl bg-it-25 mb-12">
                    {
                      typeof navigator.share === 'function' ?
                        <button
                ...
                <div className="block rounded-lg border border-me-100 bg-me-25 p-6 dark:text-me-1000">
